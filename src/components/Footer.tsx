...
const Footer = ({ lang = 'es' }: { lang?: 'es' | 'en' }) => {
  ...
  const footerSections = {
    ...
    contact: [
      { 
        name: t('footer.email'), 
        href: "mailto:export3d.design@gmail.com",
        icon: (props: any) => (
      ...
      { 
        name: t('footer.phone'), 
        href: "https://wa.me/5491164752602?text=Hola!%20Me%20interesaría%20consultar%20sobre%20sus%20servicios%20de%20render%20y%20proyecto%20y%20dirección%20de%20obra.",
        icon: (props: any) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  const socialLinks = [
    {
      ...
      href: "https://www.instagram.com/export3d.design/",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      href: "https://www.behance.net/Export3D",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    },
    {
      ...
      href: "https://www.linkedin.com/company/106047849/admin/dashboard/",
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 max-w-4xl mx-auto text-center md:text-left">
          {/* Main Navigation */}
          <motion.div
