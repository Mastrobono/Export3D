    ...
    <Container>
      ...
      >
        ...
        <div className="px-16 py-8 ">
          <h2
            id="features-heading"
            className=" font-medium text-accent font-kuunari-bold-condensed text-[24px] absolute top-10"
          >
          ...
          <div className="">
            <div className={`items-center ${textColumnStart}`}>
              <h2
                id="features-heading"
                className="font-bold text-accent  font-kuunari-bold-condensed text-[52px] mb-14 text-center"
              >
